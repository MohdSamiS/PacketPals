  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-6">About Packet Pals</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div>
          ...
          <p className="text-slate-600 dark:text-brand-muted mb-4 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
          <h3 className="text-slate-900 dark:text-white font-bold mb-4">Core Values</h3>
          <ul className="space-y-4">
            <li className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-slate-900 dark:text-white font-medium">Technical Depth</h4>
            ...
            <li className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-slate-900 dark:text-white font-medium">Open Knowledge</h4>
            ...
            <li className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-slate-900 dark:text-white font-medium">Security First</h4>
